...
/**
 * SoftwareCopyright generated by hbm2java
 */
public class SoftwareCopyright implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2189107690511508991L;
	private Integer id;
	...
	public SoftwareCopyright(int id, String college, String name, String owner, String number, int status, Date time,
			String teacher, int isPass) {
		this.id = id;
	...
	public SoftwareCopyright(int id, String college, String name, String owner, String number, int status, Date time,
			String member1, String member2, String member3, String member4, String member5, String member6,
			String member7, String member8, String member9, String member10, String teacher, String authorName,
			String authorNumber, String authorTelephone, int isPass) {
		this.id = id;
		this.college = college;
		this.name = name;
		this.owner = owner;
