...
/**
 * ProjectTagRelation generated by hbm2java
 */
public class ProjectTagRelation implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1211475455867750932L;
	private Integer id;
	...
	public ProjectTagRelation() {
	}

	public ProjectTagRelation(int projectId) {
		this.projectId = projectId;
	}

	public ProjectTagRelation(int projectId, Integer tagId1, Integer tagId2, Integer tagId3, Integer tagId4,
