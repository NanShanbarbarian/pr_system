	...
	<div class="main-content2">
		...
		<div class="form-horizontal">
		    ...
		    <div class="form-group">
	    		...
	    		<div class="col-sm-4">
	    			<input class = "form-control" type="text" name="periodical" id="periodical">
	    		</div>
	    	</div>
	    	<div class="form-group">
	    	...
	    	<div class="form-group">
	    		<div class="col-sm-4 col-sm-offset-5" style="margin-top: 30px;">
	    			<button class="btn btn-info" onclick="paper_apply()">确定申请</button>
	    		</div>
	    	</div>
		</div>
	</div>
