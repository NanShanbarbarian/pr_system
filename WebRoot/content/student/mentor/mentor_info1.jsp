		...
		<div class="form-horizontal">
	    	...
	    	<div class="form-group">
	    		...
	    		<c:if test="${gm.teachingAsistant > 0}">
	    			<c:choose>
	    				<c:when test="${msr == null}">
	    					<button class="btn btn-primary btn-normal" onclick="msr_save(1)">申请</button>
	    				</c:when>
	    				<c:otherwise>
	    	...
	    	<div class="form-group">
	    		...
	    		<c:if test="${gm.labAsistant > 0}">
	    			<c:choose>
	    				<c:when test="${msr == null}">
	    					<button class="btn btn-primary btn-normal" onclick="msr_save(2)">申请</button>
	    				</c:when>
	    				<c:otherwise>
	    	...
	    	<div class="form-group">
	    		...
	    		<c:if test="${gm.competitionNum > 0}">
	    			<c:choose>
	    				<c:when test="${msr == null}">
	    					<button class="btn btn-primary btn-normal" onclick="msr_save(3)">申请</button>
	    				</c:when>
	    				<c:otherwise>
	    	...
	    	<div class="form-group">
	    		...
	    		<c:if test="${gm.researchAsistant > 0}">
	    			<c:choose>
	    				<c:when test="${msr == null}">
	    					<button class="btn btn-primary btn-normal" onclick="msr_save(4)">申请</button>
	    				</c:when>
	    				<c:otherwise>
	    	...
	    	<div class="form-group" style="margin-top: 30px;">
	    		...
	    		<a class="btn btn-info" href="content/student/mentor/mentor_select.jsp" style="font-size: 13px;">确定返回</a>
	    		</div>
	    	</div>
	    </div>
	    </div>
