		...
		<div class="manage-content2">
			<div style="display: inline-block; float: left;">
			 	 <select class="search-select" name="search_type" id="search_type">
			 	 	<option value="1">专利名称</option>
			 	 	<option value="2">专利号</option>
           		 ...
           		 <input name="" type="button" value="搜索" class="btn btn-info search-btn" onclick="patent_search()"/>
           </div>
          <form id="excel" action="patent_exportExcel.action" method="post" style="display: inline-block; float: right;">
		...
		<table class="table table-bordered table-hover">
			...
			<tfoot>
	            <tr>
	    			...
	    			<a href="javascript:void(0);" onclick="patent_manage(1)" class="link">首页</a>
	    			<a href="javascript:void(0);" onclick="patent_manage(${currPage-1})" class="link">上一页</a>
	    			<a href="javascript:void(0);" onclick="patent_manage(${currPage+1})" class="link">下一页</a>
	    			<a href="javascript:void(0);" onclick="patent_manage(${totalPage})" class="link">末页</a>
	    			<input type="text" id="manage_page" name="manage_page" class="jump-page" />
	    			<button onclick="patent_mangage_jump()" class="btn btn-info jump-btn">跳转</button>
	    			</td>
	            </tr>
	        </tfoot>
		</table>
...
<script type="text/javascript">
	...
	$('#file').fileinput({
		language: 'zh', //设置语言
		uploadUrl: 'patent_importExcel.action',
