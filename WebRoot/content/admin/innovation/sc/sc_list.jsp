	...
	<div class="manage-content">
		<div class="manage-content2">
			<div style="display: inline-block; float: left;">
			 	 <select class="search-select" name="search_type" id="search_type">
           		 ...
           		 <input name="" type="button" value="搜索" class="btn btn-info search-btn" onclick="sc_search()"/>
           </div>
          <form id="excel" action="sc_exportExcel.action" method="post" style="display: inline-block; float: right;">
		...
		<table class="table table-bordered table-hover">
			<thead>
				<tr>
					<th>序号</th>
					<th style="width: 200px;">软件著作名称</th>
					<th style="width: 200px;">软件著作所有权人</th>
					<th style="width: 200px;">登记号</th>
					<th>软件著作状态</th>
					<th>第一作者</th>
					<th>授权时间</th>
				</tr>
			...
			<tfoot>
	            <tr>
	    			...
	    			<a href="javascript:void(0);" onclick="sc_manage(1)" class="link">首页</a>
	    			<a href="javascript:void(0);" onclick="sc_manage(${currPage-1})" class="link">上一页</a>
	    			<a href="javascript:void(0);" onclick="sc_manage(${currPage+1})" class="link">下一页</a>
	    			<a href="javascript:void(0);" onclick="sc_manage(${totalPage})" class="link">末页</a>
	    			<input type="text" id="manage_page" name="manage_page" class="jump-page"/>
	    			<button onclick="sc_mangage_jump()" class="btn btn-info jump-btn">跳转</button>
	    			</td>
	            </tr>
	        </tfoot>
		</table>
...
<script type="text/javascript">
	...
	$('#file').fileinput({
		language: 'zh', //设置语言
		uploadUrl: 'sc_importExcel.action',
