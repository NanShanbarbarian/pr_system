		...
		<div class="manage-content2">
			<div style="display: inline-block; float: left;">
			 	 <select class="search-select" name="search_type" id="search_type">
           		 ...
           		 <input name="" type="button" value="搜索" class="btn btn-info search-btn" onclick="competition_search()"/>
           </div>
          <form id="excel" action="competition_exportExcel.action" method="post" style="display: inline-block; float: right;">
		...
		<table class="table table-bordered table-hover">
			...
			<tfoot>
	            <tr>
	    			...
	    			<a href="javascript:void(0);" onclick="competition_manage(1)" class="link">首页</a>
	    			<a href="javascript:void(0);" onclick="competition_manage(${currPage-1})" class="link">上一页</a>
	    			<a href="javascript:void(0);" onclick="competition_manage(${currPage+1})" class="link">下一页</a>
	    			<a href="javascript:void(0);" onclick="competition_manage(${totalPage})" class="link">末页</a>
	    			<input type="text" id="manage_page" name="manage_page" class="jump-page" />
	    			<button onclick="competition_mangage_jump()" class="btn btn-info jump-btn">跳转</button>
	    			</td>
	            </tr>
	        </tfoot>
		</table>
...
<script type="text/javascript">
	...
	$('#file').fileinput({
		language: 'zh', //设置语言
		uploadUrl: 'competition_importExcel.action',
	...
	function query_manage(currPage) {
		...
		$.ajax({
			type: 'post',
			url: 'competition_getByQuery.action',
			data : {
