...
<body>
	<div class="manage-content">
		<div class="manage-content2">
			<div style="display: inline-block; float: left;">
			 	<button class="btn btn-info btn-normal" onclick="teacher_saveTeacher()">新增用户</button>
				<button class="btn btn-info btn-normal" data-toggle="modal" data-toggle="modal" onclick="teacher_confirm()">批量删除</button>
	           	<form id="excel" action="teacher_exportExcel.action" method="post" style="display: inline-block;" >
           ...
           <div style="display: inline-block; float: right;">
           		...
           		<input name="" type="button" value="搜索" class="btn btn-info search-btn" onclick="teacher_search()"/>
           </div>
		...
		<table class="table table-bordered table-hover">
			...
			<tfoot>
	            <tr>
	    			...
	    			<a href="javascript:void(0);" onclick="teacher_manage(1)" class="link">首页</a>
	    			<a href="javascript:void(0);" onclick="teacher_manage(${currPage-1})" class="link">上一页</a>
	    			<a href="javascript:void(0);" onclick="teacher_manage(${currPage+1})" class="link">下一页</a>
	    			<a href="javascript:void(0);" onclick="teacher_manage(${totalPage})" class="link">末页</a>
	...
	<div class="modal fade" id="confirm">
		...
		<div class="modal-body">
			...
			<button class="btn btn-info" onclick="teacher_deleteMore()" data-dismiss="modal">确定</button>
...
<script type="text/javascript">
	...
	function clickThis(loginId) {
		$.ajax({
			type : 'post',
			url : 'teacher_getTeacherById.action',
			data : {
				loginId : loginId,
			},
			dataType : 'html',
	...
	function teacher_saveTeacher() {
		$.ajax({
			type : 'post',
			url : 'content/teacher/teacher_save.jsp',
			dataType : 'html',
			success : function(data) {
				$('#manage_content').html(data);
			},
	...
	$('#file').fileinput({
		language: 'zh', //设置语言
		uploadUrl: 'teacher_importExcel.action',
