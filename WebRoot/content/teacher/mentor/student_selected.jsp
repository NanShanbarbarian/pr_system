...
<body>
	<div>
	<h4 class="col-sm-offset-5">已选人员</h4>
	<hr>
	<div class="subcontainer" id="subcontainer">
  			...
  			<c:choose>
				...
				<div class="content">
					...
					<div class="operate" style="width: 35%; text-align: center;">
					<a class="btn btn-danger btn-sm" href="javascript:void(0);" onclick="msr_refuse(${item.loginId})" >删除</a>
					</div>	
