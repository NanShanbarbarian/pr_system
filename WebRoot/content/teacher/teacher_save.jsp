	...
	<div class="main-content2">
		<div class="form-horizontal">
	    	...
	    	<div class="form-group">
	    		...
	    		<a class="btn btn-info" href="javascript:void(0);" onclick="teacher_addTeacher()" style="font-size: 13px;">新增项目发布者</a>
	    		</div>
	    	</div>
	    </div>
	</div>
...
<script type="text/javascript">
	function teacher_addTeacher() {
		$.ajax({
			type : 'post',
			url : 'teacher_saveTeacher.action',
			data : {
				name : $('#name').val(),
				number : $('#number').val(),
				academy: $('#academy').val(),
